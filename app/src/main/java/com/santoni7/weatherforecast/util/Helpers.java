...
public class Helpers {
    ...
    public static String GetDayDateString(JsonResponseWrapper.Forecast forecast){
    ...
    public static String GetIconName(JsonResponseWrapper.Forecast f){
//        return  "i" + f.getWeatherIcon();
    ...
    public static String GetDayString(JsonResponseWrapper.Forecast forecast){
        return forecast.getCalendar().getDisplayName(Calendar.DAY_OF_WEEK, Calendar.LONG, Locale.getDefault());
    }
    public static String GetShortDayString(JsonResponseWrapper.Forecast forecast){
        return forecast.getCalendar().getDisplayName(Calendar.DAY_OF_WEEK, Calendar.SHORT, Locale.getDefault());
    }
    public static String GetDateString(JsonResponseWrapper.Forecast forecast) {
